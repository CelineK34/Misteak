...
<div class="decision-hero">
    ...
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:12px;margin-bottom:20px;">
        ...
        <div class="decision-metric-card">
            <div class="decision-metric-value">{rec['confidence']}%</div>
...
other_rows_html = "".join(
    f"""<div class="other-option-row">
            <div>
                <div class="other-option-name">{opt['title']}</div>
                <div class="other-option-meta">
                    {opt['risk']} risk &middot; {opt['confidence']}% confidence
                </div>
            </div>
